...
export const EcoScoreResults = ({ data }: EcoScoreResultsProps) => {
  ...
  return (
    <div className="space-y-6">
      {/* Main Score Card */}
      <Card className="p-8 bg-gradient-to-br from-eco-surface to-background border-primary/20 shadow-xl">
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            <div className={`text-6xl font-bold text-${getScoreColor(data.score)}`}>
              {data.score}
            </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Card className="p-6 bg-card border-primary/10">
          ...
          <div className="flex items-center gap-3">
            <span className="text-2xl">{getWeightIcon(data.shipping_weight_category)}</span>
            <div>
